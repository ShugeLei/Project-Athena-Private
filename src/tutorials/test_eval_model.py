...
def evaluate(trans_configs, model_configs,
             data_configs, save=True, output_dir='../../task1_evaluations'):
    """
    ...
    results = {}
    ae_list = data_configs.get('ae_files')
    ae_file = os.path.join(data_configs.get('dir'), ae_list[14])
