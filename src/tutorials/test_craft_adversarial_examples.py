...
def generate_ae(model, data, labels, attack_configs, save=False, output_dir="../../task1_data/"):
    """
    ...
    for id in range(num_attacks):
        ...
        duration = tic - toc
        print("Example generated in ", duration, " seconds.")
